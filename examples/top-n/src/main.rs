...
fn main() {
    let mut wheel: RwWheel<TopNAggregator<TinyStr, N, U64SumAggregator, Descending>> =
        RwWheel::new(0);
    wheel.insert(Entry::new((tiny_str("test1"), 10), 1000));
    wheel.insert(Entry::new((tiny_str("test2"), 50), 1000));
    wheel.insert(Entry::new((tiny_str("test3"), 30), 1000));

    wheel.insert(Entry::new((tiny_str("test4"), 20), 1000));
    wheel.insert(Entry::new((tiny_str("test5"), 100), 1000));
    wheel.insert(Entry::new((tiny_str("test6"), 130), 1000));
    ...
    wheel.insert(Entry::new((tiny_str("test1"), 100), 2000));
    wheel.insert(Entry::new((tiny_str("test2"), 10), 2000));
    wheel.insert(Entry::new((tiny_str("test3"), 20), 2000));

    // insert some new keys
    wheel.insert(Entry::new((tiny_str("test8"), 15), 2000));
    wheel.insert(Entry::new((tiny_str("test9"), 1), 2000));
    wheel.insert(Entry::new((tiny_str("test10"), 1050), 2000));
